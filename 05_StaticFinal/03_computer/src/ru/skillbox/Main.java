...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HardDisk hardDisk1 = new HardDisk(HardDisk.HardDiskType.HDD, 3, 200);
        ...
        Computer computer = new Computer("IBM", "Home", processor1, memory1, hardDisk1, display1, keyBoard1);
